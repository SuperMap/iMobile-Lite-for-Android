...
public class SampleList extends ListActivity {
    ...
    private Class<?>[] samples = {
             BufferAnalystDemo.class,
             OverlayAnalystDemo.class,         
             SurfaceAnalystDemo.class,
             RouteCalculateMeasureDemo.class,
             RouteLocatorPointDemo.class,
             RouteLocatorLineDemo.class
            };
