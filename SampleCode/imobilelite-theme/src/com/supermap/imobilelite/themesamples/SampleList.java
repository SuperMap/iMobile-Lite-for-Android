...
public class SampleList extends ListActivity {
    ...
    private Class<?>[] samples = {
            ThemeDotDensityDemo.class,
            ThemeGraduatedSymbolDemo.class,
            ThemeGraphDemo.class,
            ThemeLabelDemo.class,
            ThemeRangeDemo.class,
            ThemeUniqueDemo.class,
            ThemeGridRangeDemo.class,
            ThemeGridUniqueDemo.class  
            };
