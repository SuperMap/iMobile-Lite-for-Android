...
public class ThemeGridRangeDemo extends Activity {
    ...
    protected static final String DEFAULT_MAP_URL = "/map-jingjin/rest/maps/京津地区人口分布图_专题图";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 设置中心点
        Point2D point = new Point2D(117.2, 40.11);
        ...
        Map<String, Boolean> params = service.getReadmeEnable("ThemeGridRangeDemo");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case 1:// 创建专题图
            if (themeLayer == null) {
                displayTheme(ThemeUtil.createThemeGridRange(mapUrl));
            }
            break;
        case 2:// 移除专题图
            if (themeLayer != null) {
    ...
    private void displayTheme(ThemeResult result) {
        ...
        Log.d("ThemeGridRangeDemo.result", JsonConverter.toJson(result));
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
        case README_DIALOG:
            Dialog dialog = new ReadmeDialog(this, R.style.readmeDialogTheme, "ThemeGridRangeDemo");
            return dialog;
        default:
            break;
        }
    ...
    protected void onPrepareDialog(int id, Dialog dialog) {
        ...
        case README_DIALOG:
            ...
            readmeDialog.setReadmeText(getResources().getString(R.string.themegridrange_readme));
            break;
        default:
            break;
        }
